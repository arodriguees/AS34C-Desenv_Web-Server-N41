...
<head>
    <title>Categoria Listagem</title>
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h2><b style="color:#fff">Listagem de Categorias</b></h2>

                            </div>
                            <div class="col-sm-6">
                                <a href="categoria_form.view.php" class="btn btn-success"><i
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php  foreach ($_SESSION["categorias"] as $key => $lanc) :?>
                            <tr>
                                <td><?= $lanc["id"] ?></td>
                                <td><?= $lanc["name"] ?></td>
                                <td><?= $lanc["descricao"] ?></td>
                                <td>
                                    <a href="categoria_form.view.php?id=<?= $lanc["id"] ?>" class="edit"><i
                                            class="material-icons" data-toggle="tooltip" title="Editar">&#xE254;</i></a>
                                    <a href="categoria_form.view.php?delete=<?= $lanc["id"] ?>" class="delete"><i
