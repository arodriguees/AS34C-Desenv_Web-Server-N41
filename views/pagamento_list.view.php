...
<head>
    <title>Pagamento Listagem</title>
...
<body>
    ...
    <section class="home-section">
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h2><b style="color:#fff">Listagem de Métodos de pagamentos</b></h2>

                            </div>
                            <div class="col-sm-6">
                                <a href="pagamento_form.view.php" class="btn btn-success"><i
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php  foreach ($_SESSION["pagamentos"] as $key => $lanc) :?>
                            <tr>
                                <td><?= $lanc["id"] ?></td>
                                <td><?= $lanc["name"] ?></td>
                                <td>
                                    <a href="pagamento_form.view.php?id=<?= $lanc["id"] ?>" class="edit"><i
                                            class="material-icons" data-toggle="tooltip" title="Editar">&#xE254;</i></a>
                                    <a href="pagamento_form.view.php?delete=<?= $lanc["id"] ?>" class="delete"><i
        ...
        <div class="text-center mt-4">
            <h4> Nenhum método de pagamento cadastrado</h4>
        </div>
        <?php endif; ?>
